...
const selectBox = document.querySelector(".select-box"),
  selectBtnX = selectBox.querySelector(".options .singel_player"),
  selectBtnO = selectBox.querySelector(".options .multi_player"),
...
function selectWinner() {
  ...
  if (
    ...
    if(playerSign=="O")
    playerName = "Opponent";
    wonText.innerHTML = `<p>${playerName}</p> won!`; //displaying winning text with passing playerSign (X or O)
  } else {
